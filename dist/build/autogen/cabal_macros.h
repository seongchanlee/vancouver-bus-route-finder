...
/* package vancouver-bus-route-finder-0.1.0.0 */
#ifndef VERSION_vancouver_bus_route_finder
#define VERSION_vancouver_bus_route_finder "0.1.0.0"
#endif /* VERSION_vancouver_bus_route_finder */
#ifndef MIN_VERSION_vancouver_bus_route_finder
#define MIN_VERSION_vancouver_bus_route_finder(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_vancouver_bus_route_finder */
...
#define CURRENT_PACKAGE_KEY "vancouver-bus-route-finder-0.1.0.0-7W4SeMiG2X8CNOqLLjzCdO"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "vancouver-bus-route-finder-0.1.0.0-7W4SeMiG2X8CNOqLLjzCdO"
